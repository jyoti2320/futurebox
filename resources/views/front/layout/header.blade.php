...
<head>
	...
	<!-- favicon -->
	<link rel="shortcut icon" href="{{ url('front/assets/images/new/logo/favicon.svg')}}" type="image/x-icon">
	  <!-- Fancybox CSS -->
	...
	<!-- Plugin css -->
	<link rel="stylesheet" href="{{ url('front/assets/css/plugin.css')}}">
	<link rel="stylesheet" href="{{ url('front/assets/vendor/swiper/swiper-bundle.min.css')}}">
	<link rel="stylesheet" href="{{ url('front/assets/vendor/animate.min.css')}}">
