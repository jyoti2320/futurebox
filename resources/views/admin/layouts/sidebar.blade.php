...
<!-- Blogs (with toggle) -->
            ...
            <li
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ $currentRoute == 'admin.blogCategory.list' ? 'active' : '' }}">
                        <a href="{{ route('admin.blogCategory.list') }}" class="menu-link">
                            <div data-i18n="Blog Category">Blog Category</div>
                        </a>
                    </li>
                    <li class="menu-item {{ $currentRoute == 'admin.blog.list' ? 'active' : '' }}">
                        <a href="{{ route('admin.blog.list') }}" class="menu-link">
                            <div data-i18n="Blogs List">Blogs</div>
                        </a>
                    </li>
                </ul>
            </li>
